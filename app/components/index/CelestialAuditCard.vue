<template>
  <div
    class="group relative flex h-80 w-full items-center overflow-hidden rounded-2xl border border-cyan-500/30 bg-[#020617] px-6 shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_30px_rgba(34,211,238,0.2)] transition-all duration-700"
  >
    <!-- Starry Layer -->
